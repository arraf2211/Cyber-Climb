...
public class P2HEAVY : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Heavy ATTACK
        if (Input.GetKeyDown(PlayerHeavy)) //if k is pressed then 
        {
        ...
        public void returnHeavy21()  //this is added to the first attack animation as an event makes sure that if the js pressed more than 2 ,make the animator play the second attck 
        {
            //HEAVY ATTACK 2
        ...
        public void returnHeavy22()//does same as above but placed at end of animation2 as an event 
        {
            ...
            if (noOfHeavyInputs >= 3)//if the inputs = 3 then play the 3 attack
            {
                ...
                animatorPlayer1.SetBool("Running", false);
            }
        ...
        public void returnHeavy23() //this is for the idle animation, at the start of it and the last attack at its end
        {
